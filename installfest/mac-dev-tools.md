...
The other package we plan to add, jshint, requires Node.js.  We'll get to it in the next set of instructions, [Tools for Node.js and Express Stack](node-express-stack.md)
...
## Slack
You should already have Slack installed and have an account from Fundamentals. You can run Slack in the browser without downloading anything. If you prefer, [download Slack here](https://slack.com/downloads).
